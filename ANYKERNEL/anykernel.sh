...
# begin properties
properties() { '
kernel.string=-#- JavaShin-X KERNEL Blue-Virtual-Dragon DirtyDragons AndroidHardened For Moto G7 Power Ocean -#-
do.devicecheck=1
do.modules=0
do.cleanup=1
do.systemless=1
...
#ui_print "KVer: 4.9.236-jsX-BvD_rV5+ jsX-Ocean SMP PREEMPT aarch64"
#ui_print "Saturday 12 September 2020"
