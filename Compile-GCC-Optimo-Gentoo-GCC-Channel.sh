...
rm ./dtbo.img
rm 4.9.2*.zip
zip -r9 4.9.240-DirtyDragons_rV8+Cahnnel-Tuesday-October-20-2020.zip * -x .git README.md *placeholder
cp 4.9.240-DirtyDragons_rV8+Cahnnel-Tuesday-October-20-2020.zip /home/javashin/Desktop/
ls -lash 4.9.240-DirtyDragons_rV8+Cahnnel-Tuesday-October-20-2020.zip ; pwd ; cd .. ; pwd
