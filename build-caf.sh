...
cd ANYKERNEL/
rm 4.9.2*.zip
zip -r9 4.9.238-DirtyDragons_rV5-Caf-OCEAN-Sun-October-04-2020.zip * -x .git README.md *placeholder
cp 4.9.238-DirtyDragons_rV5-Caf-OCEAN-Sun-October-04-2020.zip /home/javashin/Desktop/
ls -lash 4.9.238-DirtyDragons_rV5-Caf-OCEAN-Sun-October-04-2020.zip ; pwd ; cd .. ; pwd
