...
#rm ./dtbo.img
rm 4.9.2*.zip
zip -r9 4.9.240-DirtyDragons_rV8+OCEAN-Mon-October-19-2020-Stock-Q.zip * -x .git README.md *placeholder
cp 4.9.240-DirtyDragons_rV8+OCEAN-Mon-October-19-2020-Stock-Q.zip /home/javashin/Desktop/
ls -lash 4.9.240-DirtyDragons_rV8+OCEAN-Mon-October-19-2020-Stock-Q.zip ; pwd ; cd .. ; pwd
